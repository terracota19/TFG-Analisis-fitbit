...
class Controller:
    ...
    def calcular_zonas_fc(self, FCM, FCReposo):
        self.intensidades = {
            'Mejorar salud general': (0.50, 0.60),
            'Quema de grasa': (0.60, 0.70),
            'Mejorar resistencia cardiovascular': (0.70, 0.80),
            'Mejorar la velocidad y potencia': (0.80, 0.90),
            'Mejorar máximo rendimiento': (0.90, 1.00)
        }
