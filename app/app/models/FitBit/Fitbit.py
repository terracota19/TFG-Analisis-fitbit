...
class FitbitAPI:
    ...
    def userData(self, data_title, data_frec=None):
        return self.dataHandler.userData(data_title, self.user_id, data_frec)
    
    
    def userDataByRange(self, data_title, from_datetime, to_datetime):
        return self.dataHandler.userDataByRange(data_title, self.user_id, from_datetime, to_datetime)
