...
class FitbitAPI:
    ...
    """
        Stores onto csv profile info from user logged in

        Parameters:
        -data (json) : Data to be stored into a profile.csv
    """
    def saveProfile_csv(self, data):
      return self.dataHandler.saveProfile_csv(data, self.user_id)
