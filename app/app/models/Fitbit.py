...
class FitbitAPI:
    ...
    def addExpiresIn(self, new_expires_in):
        if isinstance(new_expires_in, datetime):
            ...
            self.expires_in = datetime.now(timezone.utc) + timedelta(seconds=new_expires_in)
    ...
    def storeFitInfo(self, user_id, access_token, refresh_token, expires_in):
        
        self.user_id = user_id
        self.access_token = access_token
        self.refresh_token = refresh_token
       
        self.addExpiresIn(expires_in)
