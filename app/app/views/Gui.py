...
class App(tk.Tk):
    ...
    def deleteUserAccount(self):
        def confirm_deletion():
            ...
            #and delete notebook where "good_bye_account stands on"
    ...
    def run_update_status(self):
        ...
        ult_act = self.controller.checkLasUpdate() 
        self.update_progress(25) 
        if self.update_label:
            self.update_label.config(text=f"Última Sincronización: {ult_act}")
