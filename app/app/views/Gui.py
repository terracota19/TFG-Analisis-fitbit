...
class App(tk.Tk):
    ...
    def create_login_frame(self):
        self.login_frame = tk.Frame(self.notebook, bg="#9a5bc1")
    ...
    def create_label(self, frame, text, size, fg="white", bg="#9a5bc1"):
    ...
    def create_entry(self, frame, text, show, attr_name):
        ...
        tk.Label(frame, text=text, pady=2, fg="white", bg="#9a5bc1", font=('arial', 14)).pack(anchor='w', padx=20, pady=(20, 0))
    ...
    def create_register_link(self, frame):
        register_container = tk.Frame(frame, bg="#9a5bc1")
        register_container .pack(pady=10, padx=20, fill=tk.X)
        register_label = tk.Label(register_container , text="¿No tienes cuenta? Regístrate aquí", fg="white", cursor="hand2", bg="#9a5bc1", font=('arial', 12))
    ...
    def create_button(self, frame, text, command, state="normal", label_var=None):
        ...
        button_container = tk.Frame(frame, bg="#9a5bc1")
        button_container.pack(pady=2)
        button = tk.Button(button_container, text=text, fg="white", bg="#9a5bc1", state=state, command=lambda: self.button_click(command, label_var), font=("arial", 12))
        button.pack(side=tk.LEFT) 

        if label_var is not None:
            label = tk.Label(button_container, textvariable=label_var, fg="green", bg="#9a5bc1")
    ...
    def create_app_notebook(self):
        self.app_frame = tk.Frame(self.notebook, bg="#9a5bc1")
        self.notebook.add(self.app_frame, text="HeartPred'it")
        
        header_frame = tk.Frame(self.app_frame, bg="#9a5bc1")
        header_frame.pack(side=tk.TOP, fill=tk.X)

        logout_button = tk.Button(header_frame, text="Cerrar Sesión", fg="white", bg="#9a5bc1", command=self.logout)
        logout_button.pack(side=tk.RIGHT, padx=20, pady=10)

        goodbye_acount_button = tk.Button(header_frame, text="Eliminar Cuenta", fg="white", bg="#9a5bc1", command=self.deleteUserAccount)
    ...
    def deleteUserAccount(self):
        ...
        confirm_popup.configure(bg="#9a5bc1")

        label = tk.Label(confirm_popup, text="¿Seguro que quieres eliminar la cuenta?\n¡Acción irrevocable!", bg="#9a5bc1", fg="white")
        label.pack(pady=20)

        button_frame = tk.Frame(confirm_popup, bg="#9a5bc1")
        button_frame.pack(pady=10)

        confirm_button = tk.Button(button_frame, text="Confirmar", fg="white", bg="#FF0000", command=confirm_deletion)
        confirm_button.pack(side=tk.LEFT, padx=10)

        cancel_button = tk.Button(button_frame, text="Atrás", fg="white", bg="#9a5bc1", command=confirm_popup.destroy)
    ...
    def create_status_frame(self, frame):
        self.status_frame = tk.Frame(frame, bg="#9a5bc1")
    ...
    def createLastUpdateLabel(self, frame, last_update):
        if last_update != "Nunca":
            self.update_label = self.create_label(frame, f"Última Sincronización con la pulsera: {last_update}", 14, fg="white", bg="#9a5bc1")
        else :
            self.update_label = self.create_label(frame, f"Última Sincronización con la pulsera: Nunca", 14, fg="white", bg="#9a5bc1")
    ...
    def create_register_frame(self):
        self.register_frame = tk.Frame(self.notebook, bg="#9a5bc1")
    ...
    def create_prediction_frame(self):
        self.prediction_frame = tk.Frame(self.notebook, bg="#9a5bc1")
        ...
        self.prediction_graph_frame = tk.Frame(self.prediction_frame, bg="#9a5bc1", padx=20, pady=20)
